...
const AddBlogPost = () => {
  ...
  return (
    <div className='container'>
      <h1 className="mt-3">Add Blog Post</h1>
      <form onSubmit={handleSubmit}>
        <div className="mt-2 mb-5">
            ...
            <div className="mt-3">
                <label for="urlHandle" className="form-label">Url Handle</label>
                <input 
                    type="text" 
            ...
            <div className="mt-3">
                <label for="featuredImageUrl" className="form-label">Featured Image Url</label>
                <input 
                    type="text" 
            ...
            <div className="form-check mt-3">
                <input 
                    ...
                    onChange={handleChange}
                />
                <label className="form-check-label  ms-2" for="isVisible">
                 Is Visible?
                </label>
            </div>
